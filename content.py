...
LESSONS = {
  ...
  "⚙️ System Admin": [
    ...
    {
      "title": "Text Processing: sed, awk, cut",
...
TIPS = [
  {
    ...
    "tip": "cd -    # jumps back to the last directory you were in — like a browser back button."
  },
  {
    "title": "Run the last command as root",
    "tip": "sudo !!    # re-runs your previous command with sudo. Saves retyping."
  },
  {
    "title": "Reuse the last argument",
    "tip": "mkdir /tmp/foo && cd !$    # !$ expands to the last argument of the previous command."
  },
  {
    "title": "Fix a typo in the last command",
    "tip": "^old^new    # reruns the last command replacing the first 'old' with 'new'."
  },
  {
    "title": "Find what's using a port",
    "tip": "sudo ss -tlnp sport = :8080    # shows the process listening on port 8080."
  },
  {
    "title": "Watch a log live",
    "tip": "journalctl -u nginx -f    # follow a service's logs in real time, like tail -f."
  },
  {
    "title": "Find big space hogs",
    "tip": "du -h --max-depth=1 / | sort -h    # ranks top-level directories by size."
  },
  {
    "title": "Make and enter a directory",
    "tip": "mkcd() { mkdir -p \"$1\" && cd \"$1\"; }    # one function, no more mkdir-then-cd."
  },
  {
    "title": "Search history fuzzily",
    "tip": "Install fzf, then press Ctrl+R for an interactive fuzzy search of your shell history."
  },
  {
    "title": "Remove orphan packages",
    "tip": "sudo pacman -Rns $(pacman -Qdtq)    # cleans up dependencies nothing needs anymore."
  },
  {
    "title": "Resume a broken download",
    "tip": "wget -c https://example.com/big.iso    # -c continues a partially downloaded file."
  },
  {
    "title": "Stash work in progress",
    "tip": "git stash    # shelve uncommitted changes to switch branches, git stash pop to bring them back."
  },
  {
    "title": "Colorful man pages",
    "tip": "export MANPAGER='less -R'    # in your shell rc for readable, colored manual pages."
  },
  {
    "title": "Don't fear rm",
    "tip": "Install trash-cli and alias rm='trash' — deleted files go to a recoverable trash instead of oblivion."
  },
  {
    "title": "Detach a long job",
    "tip": "Run it inside tmux, press Ctrl+b d to detach, and it keeps running even if you disconnect."
  },
  {
    "title": "Compose is your docker alias",
    "tip": "alias dc='docker compose'  # saves typing constantly"
  },
  {
    "title": "Git undo last commit safely",
    "tip": "git reset HEAD~1 --mixed  # undo commit but keep your changes staged"
  },
  {
    "title": "Find which process opened a port",
    "tip": "sudo ss -tlnp sport = :8080  # shows PID and process name"
  },
  {
    "title": "Recover deleted file from git",
    "tip": "git checkout HEAD~1 -- path/to/file.txt  # restore a file deleted in the last commit"
  },
  {
